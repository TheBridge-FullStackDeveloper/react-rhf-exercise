        ...
        <section class="py-16">
          <div class="container mx-auto text-center">
            ...
            <div class="flex flex-col md:flex-row justify-center space-y-4 md:space-x-8 md:space-y-0">
              ...
              <div class="bg-white p-8 rounded-lg shadow-md flex-1 transition duration-300 transform hover:rotate-12 hover:scale-105 hover:shadow-2xl">
                <h3 class="text-xl font-semibold mb-4">Feature 2</h3>
                <p class="text-gray-600">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                </p>
              </div>
              <div class="bg-white p-8 rounded-lg shadow-md flex-1 transition duration-600 transform hover:rotate-180 hover:shadow-2xl">
